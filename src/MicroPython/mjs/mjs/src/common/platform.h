...
#elif defined(ESP_PLATFORM) || defined(CARDPUTER) || defined(PANCAKE) || defined(ESP32) || defined(CROWPANEL_10_1)
...
#include "common/platforms/platform_rp2040.h"
