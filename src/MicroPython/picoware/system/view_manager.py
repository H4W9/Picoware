class ViewManager:
    ...
    def __init__(self):
        ...
        # Initialize video stream. Boards without a USB-OTG peripheral (the
        # ESP32-C5, for one) have no TinyUSB, so usb_video is not built for
        # them and importing it fails. Streaming is simply unavailable there.
        try:
